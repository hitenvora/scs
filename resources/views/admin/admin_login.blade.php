                ...
                <div class="content-error">
                    <div class="hpanel">
                        <div class="panel-body">
                            ...
                            <form action="{{ route('admin.login.submit') }}" method="POST" id="loginForm" class="row">
                                @csrf
                                <h5 class="text-center">Login to your account</h5>
                                <div class="form-group col-12">
                                    <label class="form-label">Mobile No.</label>
                                    <input type="text" placeholder="Enter your mobile no." value="{{ old('mobile') }}"
                                ...
                                <div class="form-group position-relative col-12">
                                    ...
                                    <input type="password" title="Enter password" placeholder="Enter your password"
                                        value="{{ old('password') }}" name="password" id="password" class="form-control">
